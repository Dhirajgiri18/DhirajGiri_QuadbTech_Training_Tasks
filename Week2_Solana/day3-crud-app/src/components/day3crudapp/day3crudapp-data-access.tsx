...
import { getDay3crudappProgram, getDay3crudappProgramId } from '@project/anchor'
...
export function useCrudProgram() {
  ...
  const programId = useMemo(() => getDay3crudappProgramId(cluster.network as Cluster), [cluster.network])
  const program = useMemo(() => getDay3crudappProgram(provider, programId), [provider, programId])
