...
import { idlFactory } from './hello_icp_backend.did.js';
export { idlFactory } from './hello_icp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HELLO_ICP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_icp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_icp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_icp_backend.did.js")._SERVICE>}
 */
export const hello_icp_backend = createActor(canisterId);
